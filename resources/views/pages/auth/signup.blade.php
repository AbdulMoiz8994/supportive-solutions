            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2 pb-5">
                <div class="mx-auto w-full max-w-md pt-5 sm:py-10">
                    <a href="/ecommerce"
                        ...
                        <svg class="stroke-current" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M12.7083 5L7.5 10.2083L12.7083 15.4167" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>
                        Back to dashboard
                    </a>
                </div>
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    ...
                    <div>
                        ...
                        <div x-data="{ loading: false }">
                            <form action="{{ route('signup.store') }}" method="POST" @submit="loading = true">
                            @csrf
                            <div class="space-y-5">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center gap-4">
                                        <div class="captcha-img rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                                            <img src="/captcha/flat?{{ time() }}" 
                                                alt="CAPTCHA" 
                                                class="block" 
                                        ...
                                        <button type="button" 
                                            ...
                                            onclick="const img = this.previousElementSibling.querySelector('img'); img.src = '/captcha/flat?' + Math.random();">
                                    ...
                                    <x-form.input label="Enter Code" type="text" name="captcha" id="captcha"
                                        placeholder="Enter the code in the image above" required />
                                </div>
                                <!-- Checkbox -->
                                <div>
