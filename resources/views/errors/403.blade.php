...
<head>
    ...
    <title>Access Denied | {{ config('app.name', 'BeydounTech Home Care') }}</title>
...
<body class="min-h-screen bg-[#eff6ff] font-onest text-[#1e293b]">
    <div class="min-h-screen flex items-center justify-center px-6">
        <div class="w-full max-w-xl rounded-3xl border border-[#dbe7fb] bg-white p-10 text-center shadow-sm">
            ...
            <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#64748b]">Error 403</p>
            <h1 class="mt-2 text-3xl font-extrabold text-[#0f172a]">Access denied</h1>
